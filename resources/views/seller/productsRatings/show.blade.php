...
@section('content')
    ...
    <div class="bg-light p-3 p-md-5 rounded">
        <h3 class="mb-4 text-xl font-semibold text-center">Your Product Ratings<br> & <br>Comments</h3>
        <div class="container mt-4 overflow-x-hidden">
            ...
            @empty
                <p class="text-muted text-center">No reviews found for your products.</p>
            @endforelse
        </div>
    </div>
