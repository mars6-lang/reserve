<nav x-data="{ open: false }" class="bg-gray border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('users.Dashboard.index')" style="text-decoration: none;">
                        {{ __('Contacts') }}
                    </x-nav-link>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('users.Market.index')" style="text-decoration: none;">
                        {{ __('E-Market') }}
                    </x-nav-link>
                    </div>
                   ...
                   <!-- <x-nav-link :href="route('users.Dashboard.index')" :active="request()->routeIs('users.Dashboard.index')">
                        {{ __('Dashboard') }}
                    </x-nav-link> -->
               ...
               <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!--<x-dropdown-link style="text-decoration: none;">
                            <h6>Logged In as</h6> <h6>{{ Auth::user()->roles[0]->name}}</h6>
                        </x-dropdown-link> -->

                      <x-dropdown-link :href="route('users.Dashboard.index')" style="text-decoration: none;">
                            {{ __('Dashboard') }}
                        </x-dropdown-link>
                        ...
                        <x-dropdown-link :href="route('users.accountsittings')" style="text-decoration: none;">
                            {{ __('Account Setting') }}
                        </x-dropdown-link>
                        
                        <x-dropdown-link :href="route('users.addressbook')" style="text-decoration: none;">
                            {{ __('Address Book') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('users.Dashboard.index')" :active="request()->routeIs('users.Dashboard.index')">
                {{ __('Dashboard') }}
